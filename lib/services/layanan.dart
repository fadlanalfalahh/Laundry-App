...
class LayananService {
  ...
  // static const String baseUrl = 'http://10.0.2.2/laundry/api/daftar_layanan';
  ...
  static Future<List<LayananModel>> getByStatus(String status) async {
    final response = await http.get(Uri.parse('$baseUrl/view.php?status=$status'));
  ...
  static Future<int?> getHargaDariLayananDanDurasi(String nama, int durasi) async {
    final url = Uri.parse('$baseUrl/get_harga_dari_durasi.php?nama=$nama&durasi=$durasi');
