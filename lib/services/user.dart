...
class UserService {
  ...
  // static const String baseUrl = 'http://10.0.2.2/laundry/api/users';
  ...
  static Future<Map<String, dynamic>> create(
      String nama, String role, String username, String password) async {
  ...
  static Future<Map<String, dynamic>> update(
      String id, String nama, String role, String username, String password) async {
