...
class PengambilanService {
  ...
  static Future<List<Map<String, dynamic>>> listPengambilan({
    ...
    final normalized = status?.trim().toLowerCase(); // 'lunas' / 'belum lunas'
    ...
    final uri = Uri.parse('$baseUrl/list_pengambilan_today.php')
    ...
    try {
      final res = await http.post(
        ...
        body: {
          ...
          if (uangDiterima != null) 'uang_diterima': uangDiterima.toString(),
        },
