...
class TransaksiService {
  ...
  // static const String baseUrl = 'http://10.0.2.2/laundry/api/transaksi';

  static Future<List<Map<String, dynamic>>> getTransaksiHariIni({String? status}) async {
    final String? normalized = status?.trim().toLowerCase(); // 'lunas' / 'belum lunas'
    final uri = Uri.parse(
  ...
  static Future<Map<String, dynamic>> cancelTransaksi(int idMaster, String role) async {
