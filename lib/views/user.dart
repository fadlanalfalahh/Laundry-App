...
class _UserPageState extends State<UserPage> {
  ...
  void _showFormDialog({UserModel? user}) {
    ...
    final controllerUsername = TextEditingController(text: user?.username ?? '');
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: SizedBox(
            width: MediaQuery.of(context).size.width * 0.85, // 85% lebar layar
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(labelText: "Password (hanya isi jika mau ganti)"),
                  obscureText: true,
                ),
              ],
            ),
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                if (user == null) {
                  ...
                  result = await UserService.update(user.id, nama, role, uname, pass);
                }
