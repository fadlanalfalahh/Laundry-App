...
class _PengambilanPageState extends State<PengambilanPage>
  ...
  String _query = '';
  DateTime? _selectedDate; // null = hari ini (default di server)
  ...
  Future<void> _pelunasanDanPickup(Map<String, dynamic> it) async {
          ...
          children: [
            ...
            ValueListenableBuilder<TextEditingValue>(
              ...
              builder: (context, value, _) {
                final uangDiterima = int.tryParse(
    ...
    final uang = int.tryParse(
      _uangDiterimaController.text.replaceAll('.', ''),
    ) ?? 0;
    if (uang < sisa) {
    ...
    setState(() => _loadingAction = true);
    final res = await PengambilanService.pickup(idMaster: idMaster, uangDiterima: uang);
    setState(() => _loadingAction = false);
      ...
      children: [
        Scaffold(
          ...
          appBar: AppBar(
            ...
            centerTitle: true,
            title: const Text('Pengambilan', style: TextStyle(color: Colors.white)),
        ...
        builder: (context, snap) {
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, i) {
              ...
              final siapAt = (it['siap_at'] ?? it['tgl_selesai'] ?? it['created_at'] ?? '').toString();
              ...
              return Card(
                ...
                child: ListTile(
                  // leading dihapus, pakai title full
                  title: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(
